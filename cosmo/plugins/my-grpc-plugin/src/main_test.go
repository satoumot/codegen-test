...
type testService struct {
  ...
  client service.MyGrpcPluginServiceClient
  cleanup   func()
}
...
func setupTestService(t *testing.T) *testService {
  ...
  service.RegisterMyGrpcPluginServiceServer(grpcServer, &MyGrpcPluginService{
    nextID: 1,
  })
  ...
  client := service.NewMyGrpcPluginServiceClient(conn)
